...
dev=/sys/devices/i2c-6/6-0055/simple_remote_pf/simple_remote
echo 0,201,1600 > $dev/accessory_min_vals
echo 200,1599  > $dev/accessory_max_vals
echo 0,100,280,500,700 > $dev/button_min_vals
echo 99,199,399,699,5000  > $dev/button_max_vals
